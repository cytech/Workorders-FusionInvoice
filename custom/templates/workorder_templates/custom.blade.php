...
<head>
    ...
    <title>{{ trans('Workorders::texts.workorder') }} #{{ $workorder->number }}</title>
...
<table>
    <tr>
        <td style="width: 50%;" valign="top">
            <h1>{{ mb_strtoupper(trans('Workorders::texts.workorder')) }}</h1>
                <span class="info">{{ mb_strtoupper(trans('Workorders::texts.workorder')) }} #</span>{{ $workorder->number }}<br>
                <span class="info">{{ mb_strtoupper(trans('fi.issued')) }}</span> {{ $workorder->formatted_created_at }}<br>
        ...
        <td style="width: 50%; text-align: right;" valign="top">
            ...
            <span class="info">{{ 'End Time: ' }}</span>{{ $workorder->formatted_end_time }}
        </td>
    </tr>
...
@if ($workorder->terms)
    <table style="margin-top: 50px;">
        ...
        <tr>
            <td>{!! $workorder->formatted_terms !!}</td>
        </tr>
    </table>
@endif

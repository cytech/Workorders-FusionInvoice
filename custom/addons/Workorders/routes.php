...
Route::group(['middleware' => 'auth.api'], function () {
    Route::group(['prefix' => 'woapi', 'namespace' => 'Addons\Workorders\Controllers'], function () {
...
Route::group(['middleware' => ['web', 'auth.admin'], 'namespace' => 'Addons\Workorders\Controllers'], function () {
